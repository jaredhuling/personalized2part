...
Use the built-in function `create.augmentation.function` from the [personalized](https://cran.r-project.org/package=personalizeds) package to construct outcome augmentation functions for the zero part model using 10-fold cross fitting:
